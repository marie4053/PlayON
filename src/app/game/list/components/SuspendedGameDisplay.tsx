...
export default async function SuspendedGameDisplay(props: { step: Step; pagination: Pagination }) {
  const { totalItems, appIds, validData } = await fetchGameScreenshots(props.step, props.pagination);
